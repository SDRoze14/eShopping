...
public class ScanCodePromotionActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private boolean checkPermission() {
        return (ContextCompat.checkSelfPermission(ScanCodePromotionActivity.this, CAMERA) == PackageManager.PERMISSION_GRANTED);
    }
    ...
    public void dispalyAlertMessage(String message, DialogInterface.OnClickListener listener) {
        new AlertDialog.Builder(ScanCodePromotionActivity.this)
                .setMessage(message)
    ...
    public void handleResult(Result result) {
        ...
        builder.setPositiveButton("ยืนยันรถเข็น", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(ScanCodePromotionActivity.this, PromotionActivity.class);
        ...
        builder.setNeutralButton("สแกนอีกครั้ง", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                scannerView.resumeCameraPreview(ScanCodePromotionActivity.this);
            }
        });
