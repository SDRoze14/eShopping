...
import dev.ecommerce.eshopping.camera.GraphicOverlay;
import dev.ecommerce.eshopping.camera.WorkflowModel;
import dev.ecommerce.eshopping.camera.WorkflowModel.WorkflowState;
import dev.ecommerce.eshopping.camera.CameraSource;
import dev.ecommerce.eshopping.camera.CameraSourcePreview;
import dev.ecommerce.eshopping.objectdetection.MultiObjectProcessor;
import dev.ecommerce.eshopping.objectdetection.ProminentObjectProcessor;
import dev.ecommerce.eshopping.productsearch.BottomSheetScrimView;
import dev.ecommerce.eshopping.productsearch.Product;
import dev.ecommerce.eshopping.productsearch.ProductAdapter;
import dev.ecommerce.eshopping.productsearch.SearchEngine;
import dev.ecommerce.eshopping.productsearch.SearchedObject;
import dev.ecommerce.eshopping.settings.PreferenceUtils;
import dev.ecommerce.eshopping.settings.SettingsActivity;
